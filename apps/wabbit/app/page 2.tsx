        ...
        <div className="flex-1 flex items-center justify-center px-4 py-16">
          <div className="text-center max-w-6xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <p className="text-2xl text-gray-600 dark:text-gray-300 font-light">Next level content creation & team-ranking. Simple.</p>
            </div>

            {/* Navigation Cards - Modern Card Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {/* Sign Up Card */}
              <Link href="/signup" className="group relative overflow-hidden bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-400 via-purple-500 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulse"></div>
              ...
              <Link 
                href="/form"
                className="group relative overflow-hidden bg-gradient-to-br from-orange-500 to-orange-600 text-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 block">
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulse"></div>
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center">
                      <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-orange-100 text-lg">Customize your preferences</p>
                </div>
              </Link>
              ...
              <button
                ...
                className="group relative overflow-hidden bg-gradient-to-br from-teal-500 to-teal-600 text-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 w-full text-left">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-teal-100 text-lg">Train your AI by ranking content</p>
                </div>
              </button>
              ...
              <button
                ...
                className="group relative overflow-hidden bg-gradient-to-br from-pink-500 to-pink-600 text-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 w-full text-left">
                <div className="absolute inset-0 bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulse"></div>
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center">
                      <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-pink-100 text-lg">View all ranked items</p>
                </div>
              </button>
