...
-- FIXED VERSION for PostgreSQL/Supabase
...
-- Use UNIQUE constraint instead of UNIQUE KEY
...
CREATE TABLE IF NOT EXISTS public.property_images (
    ...
    type VARCHAR(50) DEFAULT 'listing', -- 'listing', 'street_view', 'floor_plan'
...
CREATE INDEX IF NOT EXISTS idx_images_primary ON public.property_images (property_id, is_primary);
...
-- All scraping-related tables have been created with proper indexes and RLS policies.