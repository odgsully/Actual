# Calibration 40 Template — Fill-Out Guide & Column Role Reference
...
**Important:** The Calibration Template (`Renovation_Calibration_40_Template.xlsx`) is a **separate file** from the Analysis sheet generated by the ReportIt pipeline. They have different column layouts. This document covers the calibration template. The Analysis sheet changes are documented at the bottom.
...
| **G** | Bias Anchor? | No | No | Shopping list — flags the 7 most important slots |
...
5. **Bias anchors (Column G = Y) are the most important 7 slots** — fill these first. They test the hardest cases: expensive but dated, cheap but over-improved
...
- Template file: `[comps folder]/Renovation_Calibration_40_Template.xlsx`
