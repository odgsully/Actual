...
### Step 3: MLS 3 Year Direct Subdivision Comps Upload

**Purpose:** Upload direct comparable sales from same subdivision

**Process:**
1. **Section 4: 3 Year Direct Subdivision Comps**
2. **Upload Two Files:**
   - a. Residential 3yr-direct-subdivision-comps.csv
   - b. Residential Lease 3yr-direct-subdivision-comps.csv

**MLS Search Parameters:**
```
a. Residential 3yr-direct-subdivision-comps:
...
b. Residential Lease 3yr-direct-subdivision-comps:
- Same parameters as above
- Property type: Rental/Lease
```
