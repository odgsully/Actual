...
export default function ClientDetailPage() {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      {/* Success Message */}
      {saving === false && !error && client && (
        <div className="bg-green-50 border-2 border-green-200 rounded-lg p-4">
          <p className="text-sm font-medium text-green-800">Client updated successfully!</p>
        </div>
      )}
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="font-medium text-gray-900">
                {client && new Date(client.created_at).toLocaleDateString()}
              </p>
            </div>
            <div>
              <p className="text-gray-600">Last Updated</p>
              <p className="font-medium text-gray-900">
                {client && new Date(client.updated_at).toLocaleDateString()}
              </p>
            </div>
          </div>
        </div>
